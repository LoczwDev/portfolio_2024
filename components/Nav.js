...
export const navData = [
  ...
  { name: "video", path: "/sumaryVideo", icon: <HiCamera /> },
...
const Nav = () => {
  ...
  return (
    <nav className="flex flex-colitems-center gap-y-4 fixed h-max bottom-0 mt-auto xl:right-[2%] z-[1000] top-0 w-full xl:w-16 xl:max-w-md xl:h-screen">
        ...
        {navData?.map((link, index) => (
          ...
          >
            ...
            <div className="absolute pr-14 right-0 hidden xl:group-hover:block">
              <div className="dark:bg-white bg-accent relative flex text-primary items-center p-[6px] rounded-[3px]">
